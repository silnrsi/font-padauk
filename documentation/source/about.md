...
This project is intended to provide a free and open font family for languages and writing systems that use the Myanmar (Burmese) script. It supports the complete range of Unicode characters for the script.
