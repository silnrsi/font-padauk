---
title: Padauk - Developer information
fontversion: 6.000
---
...
The full source code for the Padauk font is available on [Github](https://github.com/silnrsi/font-padauk)
...
Because we want to be able to guarantee a high level of quality for our fonts, we will review submissions carefully. Contributions will need to cover all the weights of the family. Please don’t be discouraged if we do not include a submission due to quality or incompleteness, or if we ask you to make specific revisions.
